...
(defn grant->payload [grant {:keys [iss aud nonce issued-at expiry domain version statement]
                             :or {domain "aozora.app" version "1"}}]
...
(defn canonical-graph [did db-name]
...
(defn load-identity [{:keys [private-b64 public-b64]}]
...
(defn load-or-create-identity! [path]
